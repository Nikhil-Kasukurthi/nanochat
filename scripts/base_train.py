...
from nanochat.flash_attention import HAS_FA3, HAS_FA4, USE_FA4
...
using_fa3 = USE_FA3
if USE_FA4:
    print0("✓ Using Flash Attention 4 (Blackwell GPU detected), efficient, new and awesome.")
elif using_fa3:
    print0("✓ Using Flash Attention 3 (Hopper GPU detected), efficient, new and awesome.")
else:
    print0("!" * 80)
    if (HAS_FA3 or HAS_FA4) and COMPUTE_DTYPE != torch.bfloat16:
        print0(f"WARNING: Flash Attention only supports bf16, but COMPUTE_DTYPE={COMPUTE_DTYPE}. Using PyTorch SDPA fallback")
    else:
